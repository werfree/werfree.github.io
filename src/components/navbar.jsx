  ...
  return (
    <nav className={`${viewList ? 'backdrop-blur-sm' : 'bg-[#292929]'} md:bg-[#292929] shadow-2xl px-2 sm:px-4 py-2 md:py-1  fixed w-full z-20 top-0 left-0`}>
      ...
      <div className="flex flex-wrap items-center justify-between mx-auto">
        <span className="text-xl font-semibold whitespace-nowrap text-[#53a897]">HOWDY!</span>
        <button data-collapse-toggle="navbar-sticky" type="button" className="z-20 inline-flex items-center p-2 ml-3 text-2xl text-[#53a897] rounded-lg md:hidden focus:outline-none hover:ring-2 ring-[#53a897]" onClick={changeViewListState}>
            ...
            <div className="flex-1">
              <ul className="flex flex-col h-screen justify-center ml-[30%] md:h-fit md:ml-auto p-4 bg-[#292929] shadow-yl md:bg-transparent md:flex-row md:space-x-8 md:mt-0 md:text-base md:font-medium md:border-0 ">
                ...
                <li className="navList">
                  ...
                  <a target="_blank" href="https://drive.google.com/file/d/12fFl6HACRGxFNDZp1_ktFyQyJqfbZZp-/view?usp=sharing" className="p-2 px-3 text-center rounded-lg md:bg-transparent  md:text-sm font-sans border border-color text-color mt-2" aria-current="page" rel="noreferrer">Resume</a>
                </li>
              </ul>
            </div>
          </div>
